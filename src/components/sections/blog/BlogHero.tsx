  ...
  return (
    <section className="relative overflow-hidden pb-12 pt-20 lg:pb-16 lg:pt-28">
      ...
      <Container className="max-w-3xl text-center">
        ...
        >
          Notes on building <span className="text-gradient">good software.</span>
        </motion.h1>
        <motion.p
        ...
        >
          Engineering, design, and product lessons from projects we've
          shipped — written by the team doing the work.
        </motion.p>
      </Container>
    </section>
  );
