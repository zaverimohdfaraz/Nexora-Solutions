...
export function QuoteHero() {
  return (
    <section className="relative overflow-hidden pb-12 pt-20 lg:pb-16 lg:pt-28">
      ...
      <Container className="max-w-2xl text-center">
        ...
        <motion.h1
          ...
          className="mt-6 text-4xl font-bold leading-[1.1] text-ink dark:text-white sm:text-5xl"
        >
        ...
        <motion.p
          ...
          className="mx-auto mt-6 text-lg text-muted"
        >
          The more detail you share, the more accurate your quote. We'll
