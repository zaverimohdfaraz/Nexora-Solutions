  ...
  return (
    <section className="relative overflow-hidden pb-20 pt-20 lg:pb-28 lg:pt-28">
      ...
      <Container className="max-w-3xl text-center">
        ...
        >
          Nexora Solutions started as a two-person studio and grew into a
          full-stack partner for founders and enterprise teams who refuse to
          ship anything less than exceptional.
        </motion.p>
      </Container>
    </section>
  );
